...
# RAW DATA × 1000
capacity = {
    20: np.array([1.18, 1.20, 1.19, 1.19, 1.22, 1.23, 1.23, 1.23]) * 1000,
    30: np.array([1.724, 1.70, 1.68, 1.704, 1.74, 1.696, 1.696, 1.696]) * 1000,
    40: np.array([2.251, 2.16, 2.248, 2.238, 2.16, 2.181, 2.181, 2.181]) * 1000,
    50: np.array([2.66, 2.66, 2.71, 2.71, 2.71, 2.71, 2.71, 2.71]) * 1000,
}
